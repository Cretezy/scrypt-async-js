import scrypt, { IScryptOptions } from ".";
...
interface IScryptRunOptions {
  ...
  result: string | Array<number> | Uint8Array | ArrayBuffer;
}

const inputs: Array<IScryptOptions & IScryptRunOptions> = [
  {
    password: "p",
    salt: "s",
    logN: 1,
    ...
    encoding: "hex",
    result:
      ""
  },
  {
    password: "p",
    salt: "s",
    ...
    encoding: "base64",
    result:
      ""
  },
  {
    password: "",
    salt: "",
    ...
    encoding: "hex",
    result:
      ""
  },
  {
    password: "",
    salt: "",
  ...
  },
  {
    ...
    encoding: "base64",
    result:
      "uimV3p4s/wwh/D5tj05ZTKGfEguL8b9IPvlO2Q46ekstUchMqYgY7NoPJOdIJAE7Y0KCjSHOcYPzvDK" +
  ...
  {
    password:
      "this is a very long string, which should be pre-hashed by PBKDF2 as it exceeds block size",
    salt: "some salt",
    logN: 4,
    r: 4,
    dkLen: 16,
  ...
  },
  {
    ...
    encoding: "hex",
    result:
      ""
  },
  {
    ...
    encoding: "hex",
    result:
      ""
  }
];
...
describe("limits test", function() {
  ...
  it("should throw with too small logN", async () => {
    await throws(scrypt(v.password, v.salt, { logN: 0 }));
  });

  it("should throw with too big logN", async () => {
    await throws(scrypt(v.password, v.salt, { logN: 32 }));
  });

  it("should throw with too big N", async () => {
    await throws(scrypt(v.password, v.salt, { N: (-1 >>> 0) + 1 }));
  });

  it("should throw with too small N", async () => {
    await throws(scrypt(v.password, v.salt, { N: 1 }));
  });

  it("should throw when N is not power of two", async () => {
    await throws(scrypt(v.password, v.salt, { N: 123 }));
  });

  it("should throw with too large parameters", async () => {
    await throws(scrypt(v.password, v.salt, { r: 1 << 31 }));
  });

  it("should throw when r = 0", async () => {
    await throws(scrypt(v.password, v.salt, { r: 0 }));
  });

  it("should throw when p = 0", async () => {
    await throws(scrypt(v.password, v.salt, { p: 0 }));
  });
});
...
describe("encoding test", function() {
  ...
  it('should return string for "hex"', async () => {
    const out = await scrypt(v.password, v.salt, { encoding: "hex" });
    expect(typeof out).toBe("string");
  });

  it('should return string for "base64"', async () => {
    const out = await scrypt(v.password, v.salt, { encoding: "base64" });
    expect(typeof out).toBe("string");
  });

  if (typeof Uint8Array !== "undefined") {
    it('should return Uint8Array for "binary"', async () => {
      const out = await scrypt(v.password, v.salt, { encoding: "binary" });
      expect(out instanceof Uint8Array).toBe(true);
    });
  }

  it("should return Array for undefined", async () => {
    const out = await scrypt(v.password, v.salt);
    expect(Object.prototype.toString.call(out)).toBe("[object Array]");
  });
});

async function async_test(i, interruptStep) {
  const v = inputs[i];

  const out = await scrypt(v.password, v.salt, { ...v, interruptStep });

  expect(v.result).toEqual(out);
}

describe("async input/output test", () => {
  const step = 1000;

  it("input 0", async () => {
    await async_test(0, step);
  });
  it("input 1", async () => {
    await async_test(1, step);
  });
  it("input 2", async () => {
    await async_test(2, step);
  });
  it("input 3", async () => {
    await async_test(3, step);
  });
  it("input 4", async () => {
    await async_test(4, step);
  });
  it("input 5", async () => {
    await async_test(5, step);
  });
  it("input 6", async () => {
    await async_test(6, step);
  });
  it("input 7", async () => {
    await async_test(7, step);
  });
  it("input 8", async () => {
    await async_test(8, step);
  });
  it("input 9", async () => {
    await async_test(9, step);
  });
  it("input 10", async () => {
    await async_test(10, step);
  });
});
...
async function async_test_opts(i, interruptStep) {
  const v = inputsWithP[i];
...
describe("async input/output test with options and p with zero interruptStep", function() {
  ...
  it("input 0", async () => {
    await async_test_opts(0, step);
  });
  // // Takes too long
  // it('input 1', async () => {
  // 	await async_test_opts(1, step);
  // });
});
